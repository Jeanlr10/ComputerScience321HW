...
public class ClassMethodLab{
    public static void main(String[] args)
    {
        ...
        System.out.println("all uppercase: "+CaseChange.allUpper(str)); // tests the allUpper method converting str to all uppercase
        System.out.println("all lowercase: "+CaseChange.allLower(str)); // tests the allLower method converting str to all lowercase
        //
        //
